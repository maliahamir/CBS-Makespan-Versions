...
public:
	...
	double root_generation_time = 0; // runtime of generating the root node
...
private:
	...
	pairing_heap< CBSNode*, compare<CBSNode::makespan_compare_node> > open_list;
