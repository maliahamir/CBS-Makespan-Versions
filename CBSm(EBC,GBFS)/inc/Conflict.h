...
//VERTEX = can't be at loc at time t.
//EDGE = swap constraint.
//RANGE = vertex constraint at a range of timesteps.
//BARRIER = straight line of vertex constraints.
//GLENGTH = "Greater Length" - the path of the agent must be of length greater than t.
//LEQLENGTHH = "Less/Equal Length" - the path of the agent must be of length at most t.
//POSITIVE VERTEX = must be at vertex x at time t
//POSITIVE EDGE = must be at vertex x at time t-1 and at vertex y at time t
//POSITIVE RANGE = must be at vertex x at a range of timesteps
//POSITIVE BARRIER = 
